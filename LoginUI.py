...
class Ui_MainPage(object):
    def setupUi(self, MainPage):
        ...
        self.sportFlow.setGeometry(QtCore.QRect(10, 100, 141, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.nsportFlow.setGeometry(QtCore.QRect(10, 140, 141, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        ...
        self.lastBetTime.setGeometry(QtCore.QRect(140, 100, 141, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        ...
        self.upamountTime.setGeometry(QtCore.QRect(140, 140, 171, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        ...
        self.parent.setGeometry(QtCore.QRect(140, 180, 141, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        ...
        self.fielLabel = QtWidgets.QLabel(self.centralwidget)
        self.fielLabel.setGeometry(QtCore.QRect(30, 70, 61, 21))
        self.fielLabel.setObjectName("fielLabel")
        ...
        self.Version.setGeometry(QtCore.QRect(0, 0, 101, 20))
        self.Version.setObjectName("Version")
        self.daogeData = QtWidgets.QCheckBox(self.centralwidget)
        self.daogeData.setGeometry(QtCore.QRect(10, 180, 141, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        self.daogeData.setFont(font)
        self.daogeData.setObjectName("daogeData")
        self.userVIP = QtWidgets.QCheckBox(self.centralwidget)
        self.userVIP.setGeometry(QtCore.QRect(140, 220, 141, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        self.userVIP.setFont(font)
        self.userVIP.setObjectName("userVIP")
        self.rescue = QtWidgets.QCheckBox(self.centralwidget)
        self.rescue.setGeometry(QtCore.QRect(10, 220, 141, 31))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainPage):
        ...
        self.fielLabel.setText(_translate("MainPage", "檔案位置："))
        self.filePath.setText(_translate("MainPage", "待导入...."))
        self.startButton.setText(_translate("MainPage", "查询"))
        self.Version.setText(_translate("MainPage", "Version:1.0-beta"))
        self.daogeData.setText(_translate("MainPage", "道哥奇耙数据"))
        self.userVIP.setText(_translate("MainPage", "VIP等级"))
        self.rescue.setText(_translate("MainPage", "救援金"))
