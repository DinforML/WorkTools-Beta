...
def start_driver(platform):
	...
	driver.get(url_link[platform]['domain'])
	return driver
...
def login(driver,accountText,passwordText,codeText):
...
def sport_search(driver,temp_list,filePath):
...
if __name__ == "__main__":
	...
	while True:
		...
		input("数据已导出'数据.csv'，点击 Enter 继续下一次批量查询")
		clean()
		driver.get(homePage)
